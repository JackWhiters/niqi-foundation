                    ...
                    <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                        ...
                        <div className="w-full">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5">
                                <div>
                                    <InputBox name="fullname" type="text" value={fullname} placeholder="Nama Lengkap" disable={true} icon={fi-rr-user} />
                                    <InputBox name="email" type="email" value={email} placeholder="Alamat Email" disable={true} icon={fi-rr-envelope} />
                                </div>
                            </div>

                            <InputBox type="text" name="username" value={profile_username} placeholder="Username" icon="fi-rr-at" />

                            <p className="text-dark-grey -mt-3">Username akan digunakan sebagai pencarian pengguna dan akan ditampilkan kepada semua pengguna</p>
