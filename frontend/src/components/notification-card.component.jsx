    ...
    return (
        <div className={"p-6 border-b border-grey border-l-black " + ( !seen ? "border-l-2" : "" )}>
                ...
                <div className="w-full">
                    <h1 className="font-medium text-xl text-dark-grey">
                        ...
                        <span className="font-normal"> 
                            {
                                type == 'like' ? "menyukai artikelmu" :
                                type == 'comment' ? "berkomentar pada" : "membalas pada"
                            }
                        </span>
                    </h1>
            ...
            <div className="ml-14 pl-5 mt-3 text-dark-grey flex gap-8">
...

                {
                    ...
                    <>
                        {
                            !reply ?
                            <button className="underline hover:text-black" onClick={handleReplyClick}>Balas</button> : ""
                        }
                        <button className="underline hover:text-black" onClick={(e) => handleDelete(comment._id, "comment", e.target)}>Hapus</button>
                    </> : ""
                }
...

            {
                ...
                isReplying ?
                <div className="mt-8">
                    <NotificationCommentField _id={_id} blog_author={user} index={index} replyingTo={comment._id} notification_id={notification_id} notificationData={notificationState} />
                </div> : ""
...

            {
                ...
                <div className="ml-20 p-5 bg-grey mt-5 rounded-md">
                    ...
                    <button className="underline hover:text-black ml-144 mt-2" onClick={(e) => handleDelete(comment._id, "reply", e.target)}>Hapus</button>
